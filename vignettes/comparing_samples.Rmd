...
## Using the Hilbert index to visualize cell densities
...
The Hilbert curve can be re-folded back into any dimensionality, for example to visualize data as a scatter plot:
